    ...
    <div className='bg-red-50 border border-red-200 rounded-lg p-3 sm:p-4 my-4'>
      <div className='flex items-start'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-xs sm:text-sm text-red-700 mb-3'>{errorInfo.message}</p>
          <LoadingButton
            loading={false}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 max-w-4xl mx-auto'>
          {plans.map((plan) => (
            ...
            >
              ...
              <div
                className={`bg-gradient-to-r ${plan.gradient} p-4 sm:p-6 text-white ${
              ...
              >
                ...
                <div className='text-center mb-3 sm:mb-4'>
                  ...
                  <span className='text-base sm:text-lg opacity-80'> ARS/mes</span>
                </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6'>
            ...
            <div className='bg-white p-4 sm:p-6 rounded-lg border border-gray-200'>
              <div className='text-center mb-3 sm:mb-4'>
                ...
                <h4 className='font-semibold text-gray-800 text-base sm:text-lg'>Plan Lite</h4>
                <p className='text-green-600 font-bold text-sm sm:text-base'>GRATUITO</p>
              </div>
              <ul className='text-xs sm:text-sm text-gray-600 space-y-1.5 sm:space-y-2'>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>3 agentes
                  básicos
                </li>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>100
                  mensajes/mes
                </li>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>Perfecto
                  para probar
                </li>
              </ul>
            </div>
            ...
            <div className='bg-blue-50 p-4 sm:p-6 rounded-lg border border-blue-200'>
              <div className='text-center mb-3 sm:mb-4'>
                ...
                <h4 className='font-semibold text-gray-800 text-base sm:text-lg'>Plan Pro</h4>
                <p className='text-blue-600 font-bold text-sm sm:text-base'>Para emprendedores</p>
              </div>
              <ul className='text-xs sm:text-sm text-gray-600 space-y-1.5 sm:space-y-2'>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>Todos los
                  agentes
                </li>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>1.000
                  mensajes/mes
                </li>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>Ideal para
                  PyMEs
                </li>
              </ul>
            </div>
            ...
            <div className='bg-purple-50 p-4 sm:p-6 rounded-lg border border-purple-200'>
              <div className='text-center mb-3 sm:mb-4'>
                ...
                <h4 className='font-semibold text-gray-800 text-base sm:text-lg'>Plan Elite</h4>
                <p className='text-purple-600 font-bold text-sm sm:text-base'>Para empresas</p>
              </div>
              <ul className='text-xs sm:text-sm text-gray-600 space-y-1.5 sm:space-y-2'>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>Agentes
                  premium
                </li>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>2.000
                  mensajes/mes
                </li>
                <li>
                  <i className='fas fa-check text-green-500 mr-1 sm:mr-2'></i>Soporte
                  prioritario
                </li>
              </ul>
            </div>
